...
name: Discord.Events.InteractionCreate,
    ...
    readdirSync('./commands').forEach(f => {
      ...
      if(interaction.commandName.toLowerCase() === cmd.name.toLowerCase()) {
        ...
        const btn = createButton(interaction, {
          ...
          emoji: "<:emoji_22:1151213400010010707>",
        ...
        if(!rulesisread) {
          ...
          .setTitle("> <:emoji_22:1151213400010010707>・Kuralları kabul etmek için **Kabul Ediyorum.** butonuna tıklayın!\n> <:emoji_2:1151204216308781147>・Ama bunu yapmadan önce bi linklere göz atmanı isterim!")
          .setDescription("\n\n**<:emoji_2:1151204216308781147> Linkler**\n> <:emoji:1150602727106301992>・**Botun kullanım koşulları: [Tıkla](https://serius-bot.vercel.app/tos)**\n> <:emoji:1148961234432053328>・**Botun gizlilik politikası: [Tıkla](https://serius-bot.vercel.app/privacy)**")
          .setColor('Blue')
  ...
  .setCustomId("ooeoeo"))
      ...
      .setTitle("> <:emoji_10:1151204385943195718>・Kuralları kabul ettiğin için teşekkürler artık botun tadını çıkarabilirsin!")
      .setColor('Blue')
  ...
  if(interaction.isModalSubmit()) {
    if (interaction.customId === 'kayitform') {
     ...
     if (interaction.customId === 'form') {
      ...
      if (!onay) interaction.reply({ content: "<:emoji_23:1151213417038884874> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!logg) interaction.reply({ content: "<:emoji_23:1151213417038884874> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!botRol) interaction.reply({ content: "<:emoji_23:1151213417038884874> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!devRol) interaction.reply({ content: "<:emoji_23:1151213417038884874> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!adminRol) interaction.reply({ content: "<:emoji_23:1151213417038884874> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!botekle) interaction.reply({ content: "<:emoji_23:1151213417038884874> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!ayrildiLog) interaction.reply({ content: "<:emoji_23:1151213417038884874> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      ...
      const gonderildi = new EmbedBuilder()
          .setTitle("<a:1149408550716711032:1150169060215115796> | Başarılı!")
      ...
      oda.permissionOverwrites.create(
        ...
        interaction.reply("<:emoji_22:1151213400010010707> | <@"+id+"> Adlı Kullanıcı Odadan Başarıyla Atıldı")
      } else {
    }
    ...
    oda.permissionOverwrites.create(
      ...
      interaction.reply("<:emoji_22:1151213400010010707> | <@"+id+"> Adlı Kullanıcı Odaya Eklendi")
    } else {
  }
 ...
 .addComponents(
  ...
  interaction.reply({ content: `<:emoji_22:1151213400010010707> **|** Senin için bir tane destek kanalı ${channel} oluşturldu.`, ephemeral: true })
...
if(interaction.customId === 'giriscikis'){
  ...
  if (sayacmessage && sayacmessageDate) {
      ...
      .setDescription(`<:emoji_23:1151213417038884874> | Bu sistem <t:${parseInt(sayacmessageDate.date / 1000)}:R> önce açılmış!`)
  ...
  .setDescription("<:emoji_22:1151213400010010707> **|** Giriş çıkış mesajı aktif edildi!")
  .addFields([
    {
  ...
  return interaction.update({ embeds: [embed], components: [row1] })
    ...
    if(interaction.customId === "rol_everyone") {
      ...
      interaction.reply({content: "<:emoji_22:1151213400010010707> | Rol Başarıyla Verildi!", ephemeral: true})
       } else {
         
        interaction.member.roles.remove(butonrol)
      interaction.reply({content: "<:emoji_22:1151213400010010707> | Rol Başarıyla Alındı!", ephemeral: true})
    }
      }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:mod:1039607060775571476> | Serius - Moderasyon Menüsü!")
          .addFields(
      ...
      .setTitle("> <:mod:1039607060775571476> | Serius - Moderasyon 2 Menüsü!")
      .addFields(
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:ek:1039607052340834354> | Serius - Kayıt Menüsü!")
          .addFields(
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:member:1039607059357913098> | Serius - Kullanıcı Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        if (interaction.customId == "korumasystem_"+interaction.user.id) {
          const embed = new Discord.EmbedBuilder()
          .setTitle("> <:koruma:1044325545925672976> | Serius - Koruma Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:bot:1039607042291269703> | Serius - Botlist Menüsü!")
          .addFields(
      ...
      const embed = new Discord.EmbedBuilder()
      .setTitle("> <:ses:1041739960493019197> | Serius - Özel Oda Menüsü!")
      .addFields(
      ...
      .setColor("Random")
        ...
        if (interaction.customId == "anasayfa_"+interaction.user.id) {
          ...
          .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
          .setDescription("\n\n**<:links:1039607057923461181> Linkler**\n> <:bot:1039607042291269703>・**Botun davet linki: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1150925347676753931&permissions=8&scope=bot%20applications.commands)**\n> <:duyuru:1039607050734403657>・**Botun destek sunucusu: [Tıkla](https://discord.gg/BxqAUr3JQf)**\n> <:newmember:1044325552007422052>・**Botun gizlilik politikası: [Tıkla](https://serius-bot.vercel.app/privacy)**")
          .setColor('Blue')
          const row = new Discord.ActionRowBuilder()
          .addComponents(
      new Discord.ButtonBuilder()
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:yenilik:1044325577064190033> | Serius - Ticket Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | Serius - Level Menüsü!")
          .addFields(
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | Serius - Captcha Menüsü!")
          .addFields(
        ...
        interaction.deferUpdate();
          ...
          if (interaction.customId === "muteonay_"+interaction.user.id) {
            ...
            const dmb = deleteMessageButton(interaction, {
              ...
              emoji: "<:emoji_34:1150800117595656243>"
        });
            let muterol = db.fetch(`rol_${interaction.guild.id}`)
            let ucanEssek = interaction.guild.members.cache.get(kullanıcı)
            if (!ucanEssek) return interaction.reply("<:emoji_23:1151213417038884874> | Üyeyi bulamadım.")
            ucanEssek.roles.add(muterol)
            const embed = new EmbedBuilder()
            .setDescription(`<:emoji_22:1151213400010010707> | Başarılı bir şekilde <@!${kullanıcı}> isimli kişiye mute atıldı.
        `)
          ...
          if (interaction.customId === "mutered_"+interaction.user.id) {
            ...
            const dmb = deleteMessageButton(interaction, {
              label: "Mesajı sil.",
              style: Discord.ButtonStyle.Secondary,
              emoji: "<:emoji:1151233472627744820>"
        });
            const embed = new EmbedBuilder()
            .setDescription(`<:emoji_22:1151213400010010707> | Başarılı bir şekilde mute iptal edildi.
        `)
            interaction.update({embeds: [embed], components: [row, dmb]})
          }
            ...
            **__${interaction.guild.name} Sunucu Kuralları__**                                    
            ...
            interaction.guild.channels.create({name: "💬・sohbet", type: ChannelType.GuildText}).then(sohbet => {
                ...
                .setTitle('Serius Bot - İyi günler diler.')
            ...
            interaction.guild.roles.create({ name: 'Kurucu', color: "White", permissions: [PermissionsBitField.Flags.Administrator]}).then(rol => {
            ...
            if (interaction.customId === "sunucukurred_"+interaction.user.id) {
              interaction.update({content: `<:emoji_22:1151213400010010707> | Başarılı bir şekilde sunucu kurma iptal edildi!`, embeds: [], components: []})
            } 
          ...
          var sonBos = "<:emoji_6:1151204319350235157>"
            ...
            if (interaction.customId === "botekle_everyone") {
              ...
              .setTitle("<:emoji_23:1151213417038884874> | Başarısız!")
          ...
          if (interaction.customId === "ayarlar_"+interaction.user.id) {
            ...
            const yetki = new Discord.EmbedBuilder()
                .setTitle("<:emoji_23:1151213417038884874> | Yetersiz Yetki!")
        ...
        if (interaction.customId === "kapat_"+interaction.user.id) {
          ...
          const embed1 = new Discord.EmbedBuilder()
              .setTitle("<:emoji_22:1151213400010010707> | Başarıyla Sıfırlandı!")
      ...
      .setTitle('Serius - Özel Oda Kullanıcı Ekleme!')
        ...
        if(interaction.customId === "ekle_"+interaction.user.id){
          ...
          if (!odasiz) return interaction.reply({content: "<:emoji_23:1151213417038884874> | Sana Ait Bir Oda Bulamadım!", ephemeral: true})
          await interaction.showModal(mod);
        }

        const mod2 = new ModalBuilder()
        .setCustomId('eklemenu2')
        .setTitle('Serius - Özel Oda Kullanıcı Çıkarma!')
          ...
          if (interaction.customId === "unban_everyone") {
            ...
            if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `<:emoji_23:1151213417038884874> | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
            ...
            const embed1 = new Discord.EmbedBuilder()
                .setTitle("<:emoji_23:1151213417038884874> | Başarılı!")
        ...
        if (interaction.customId === "reddet_everyone") {
          ...
          if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `<:emoji_23:1151213417038884874> | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
            ...
            if (!interaction.member.roles.cache.has(botlistadmin)) return interaction.reply({ content: "<:emoji_23:1151213417038884874> | Bu işlemi gerçekleştirmek için <@&" + botlistadmin + "> rolüne sahip olmalısın!", ephemeral: true })
            ...
            const embed = new EmbedBuilder()
                .setTitle("<:emoji_23:1151213417038884874> | Bot Reddedildi!")
        ...
        const embed = new Discord.EmbedBuilder()
        .setAuthor({ name: "Serius Destek Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
        ...
        .setImage(`https://cdn.discordapp.com/attachments/1150929570887913472/1151308996163149834/IMG_0329.png`)
        .setColor('Blue')
          ...
          if(find) {
            ...
            .setDescription(`<:emoji_23:1151213417038884874> Zaten bir talebin bulunmakta.`)
        ...
        if(interaction.customId === `ticketClose_everyone`) {
          ...
          .setDescription(`<:emoji_22:1151213400010010707> | Bu destek talebi kapatılmıştır.`)
          .setColor('Green')
        ...
        if(interaction.customId === `ticketDelete_everyone`) {
         ...
         const usr = db.fetch(`ticketUser_${x}${interaction.guild.id}`);
          ...
          .addFields(
            { name: "Destek Açan: <:emoji_9:1151204367056261260>", value: `<@${usr.whOpen}>`, inline: true },
...
if(interaction.customId === `benıdogrula_everyone_${interaction.guild.id}${interaction.user.id}`)
      ...
      await interaction.showModal(giriscikismodal);
        ...
        if(interaction.customId === `giriscikismesajsifirla_`+interaction.user.id) {
          ...
          if (!sayacmessage) {
              const date = new EmbedBuilder()
              .setDescription(`<:emoji_23:1151213417038884874> | Bu sistem zaten kapalı!`)
          ...
          .setColor(0x2F3136)
          .setAuthor({ name: `${interaction.user.tag}`, iconURL: `${interaction.user.displayAvatarURL()} ` })
          .setDescription("<:emoji_22:1151213400010010707> **|** Giriş çıkış mesajı sıfırlandı!")
