...
try {
            ...
            channel.send({
                content: `<@${member.user.id}>`, embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription('• Merhaba Serius kullanıcısı, seni sunucumuza güvenle alabilmek için altta bulunan yazıyı butona tıklayarak yazman gerekiyor.')
        ...
        registerChannel.send({ content: `${member}`, embeds: [
            {
                description: `<:cs_login:1150782797594763315> | Seni aramızda görmekten mutluluk duyuyoruz!\n\n<:cs_bots:1150725037159100496> | Sunucumuza katılan **${member.guild.memberCount}.** üyesin.\n\n<:emoji:1150783531673469059> | Hesabın <t:${parseInt(member.user.createdTimestamp  / 1000)}:R> açılmıştır.\n\n<:emoji:1150601336228941946> | Sunucumuzun kurallarını okumayı unutma iyi eğlenceler.`
            }
        ], components: [row] })
    } catch(err) { }
