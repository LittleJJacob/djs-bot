...
module.exports =  {
  ...
  message.delete()
  message.channel.send(`<a:789241725523591229:1150162855228887141> | Hey <@${message.author.id}>, Bu Sunucuda Küfür Engel Sistemi Aktif! `)
  }
  }
  ...
  if(linkler.some(alo => message.content.toLowerCase().includes(alo))) {
    ...
    if(message.author?.bot) return;
  message.delete()
  message.channel.send(`<a:789241725523591229:1150162855228887141> | Hey <@${message.author.id}>, Bu Sunucuda Reklam Engel Sistemi Aktif! `)
  }
  }
    ...
    if(message.channel.id == kanal){
      ...
      message.delete()
      const embed = new EmbedBuilder()
      .setTitle(`<:emoji:1150601336228941946> **UYARI!**`)
