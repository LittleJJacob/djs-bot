...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    switch(saasSystemTrue) {
      case "ac": {
        if(saasSystem) return interaction.reply({ content: "<:emoji_23:1151213417038884874> | Bu sistem zaten açık!" });
      ...
      case "kapat": {
        if(!saasSystem) return interaction.reply({ content: "<:emoji_23:1151213417038884874> | Bu sistem zaten kapalı?" });
