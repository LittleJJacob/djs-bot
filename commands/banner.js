...
return interaction.reply({embeds: [embed]})
  ...
  const embed = new EmbedBuilder()
  .setDescription(`:x: Bu kullanıcıda banner bulunmamaktadır! \n\n 📔 Not: Hata olduğunu düşünüyorsanız [Discord](https://discord.gg/BxqAUr3JQf) sunucumuza gelebilir yada **bug** komutunu kullanabilirsiniz.`)
  return interaction.reply({ embeds: [embed] });
  }  
...
return interaction.editReply({ content: "selam" })
//veya
return interaction.followUp({ content: "selam" })  
