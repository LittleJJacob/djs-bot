    ...
    switch(reklamEngelSystemTrue) {
      case "ac": {
        ...
        if (reklamEngelSystem && reklamEngelSystemDate) {
            ...
            .setDescription(`<:emoji_23:1151213417038884874> | Bu sistem <t:${parseInt(reklamEngelSystemDate.date / 1000)}:R> önce açılmış!`)
      ...
      case "kapat": {
        if(!reklamEngelSystem) return interaction.reply({ content: "<:emoji_23:1151213417038884874> | Bu sistem zaten kapalı?" });
