...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if (ozelOdaSystem && ozelOdaSystemDate) {
        ...
        .setDescription(`<:emoji_23:1151213417038884874> | Bu sistem <t:${parseInt(ozelOdaSystemDate.date / 1000)}:R> önce açılmış!`)
  ...
  const channel = await interaction.guild.channels.create({
    ...
    interaction.reply("<:emoji_22:1151213400010010707> | Sesli Kanal Başarıyla Oluşturuldu.")
}
