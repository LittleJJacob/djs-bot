   ...
   switch(hesapkorumaSystemTrue) {
    case "ac": {
      ...
      if (hesapkorumaSystem && hesapkorumaSystemDate) {
          ...
          .setDescription(`<:emoji_23:1151213417038884874> | Bu sistem <t:${parseInt(hesapkorumaSystemDate.date / 1000)}:R> önce açılmış!`)
    ...
    case "kapat": {
      if(!hesapkorumaSystem) return interaction.reply({ content: "<:emoji_23:1151213417038884874> | Bu sistem zaten kapalı?" });
