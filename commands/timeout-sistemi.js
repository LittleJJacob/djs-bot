...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (timeoutSistemi && timeoutSistemiDate) {
            ...
            .setDescription(`<:emoji_23:1151213417038884874> | Bu sistem <t:${parseInt(timeoutSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:emoji_22:1151213400010010707> | __**Timeout Sistemi**__ başarıyla ayarlandı! __/timeout__ komutu ile sistemi kullanabilirsin.\n\n<:emoji_21:1151204901976821840> Log Kanalı: ${kanal}\n<:emoji_20:1151204867361218640> Yetkili Rolü: ${rol}`)
