...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const sunucuSahibi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:emoji_23:1151213417038884874> | Sunucu sahibini susturamazsın dostum.")

        const kendiniSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:emoji_23:1151213417038884874> | Kendine neden timeout atmak istersin ki?")

        const botuSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:emoji_23:1151213417038884874> | Ben bir botum, beni susturup ne yapacaksın?")

        const gecerliSure = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:emoji_23:1151213417038884874> | Susturabilmem için geçerli bir süre girmelisin.")
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Yellow")
            .setTitle("<:emoji_22:1151213400010010707> | Bir Üye Susturuldu!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:emoji_22:1151213400010010707> | ${kullanıcı} adlı kullanıcıya **${süre}** süre boyunca timeout atıldı!`)
